<div class="bg-white rounded-md mt-4 py-2">
    ...
    <div class="px-5">
      ...
      <div class="  flex justify-between">
        ...
        <a wire:navigate href="{{ route('site.area.view', [$site->slug, $area->slug]) }}" class="hidden sm:block cursor-pointer w-32 bg-gray-900 text-white hover:bg-gray-700" >
          <p class="flex ml-4 mt-4 mb-4 font-semibold items-center justify-center">{{ __('See') }} 
            <svg class="ml-2" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/></svg>
          </p>
        </a>
      </div>
     <a wire:navigate
            ...
            <span class="font-semibold">{{ __('See') }}</span>
