...
<div>
<div class=" flex items-center p-0 overflow-hidden bg-center bg-cover h-96 rounded-2xl" style="background-image: url('https://escalade-gourdon.fr/wp-content/uploads/2018/11/cours-escalade.jpg'); background-position-y: 50%; filter: opacity(37.9%) grayscale(100%);">
