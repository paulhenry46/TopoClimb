<div class="bg-white rounded-md mt-3">
    <div class="py-5 ml-5 font-semibold text-xl">Informations & Contact</div>
    <div class="mt-2 flex w-full flex-none gap-x-4  px-6">
        ...
        <dd class="text-sm font-medium leading-6 hover:text-gray-900 text-gray-500">Website</dd>
      </div>
      <div class="mt-4 flex w-full flex-none gap-x-4 px-6">
        ...
        <dd class="text-sm leading-6 text-gray-500">
          <time datetime="2023-01-31">Tel</time>
        </dd>
      </div>
      <div class="mt-4 flex w-full flex-none gap-x-4 px-6">
        <dt class="flex-none">
        ...
        <dd class="text-sm leading-6 text-gray-500">Mail</dd>
      </div>
      <div class="py-4 flex w-full flex-none gap-x-4 px-6">
        ...
        <dd class="text-sm leading-6 text-gray-500">Localisation</dd>
      </div>
</div>