        ...
        return is_null($route->removing_at) || $route->removing_at > now();
                ...
                <div class=' my-3 justify-between items-center w-full flex'>
                    <div class='flex items-center'>
                        ...
                        <div class=" text-2xl text-center w-24 bg-{{$route->color}}-300 relative whitespace-nowrap py-4 font-medium text-gray-900"> {{$site->cotations_reverse()[$route->grade]}} </div>
                        <div class="  whitespace-nowrap pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-3">
                            <div class="flex items-center">
                                <div>
