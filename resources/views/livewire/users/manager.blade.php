  ...
  <div class="px-4 sm:px-6 lg:px-8 py-8">
      <div class="sm:flex sm:items-center">
          ...
          <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
              <x-button type="button">{{__('Add site')}}</x-button>
          </div>
      </div>
                  ...
                  <table class="min-w-full divide-y divide-gray-300">
                      <thead>
                          <tr>
                              ...
                              <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">{{__('Roles')}}</th>
                      ...
                      <tbody class="bg-white"> 
                        @foreach ($this->users as $user) <tr class="even:bg-gray-50">
                              ...
                              <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">p</td>
                                      ...
                                      <div class="space-y-2 px-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:space-y-0 sm:px-6 sm:py-5">
                                          ...
                                          <div class="sm:col-span-2"> 
                                              ...
                                              <div class="space-y-4 mt-4">
                                                  <x-label for="site" value="{{ __('Select Site') }}" /> <select x-model="current_site_id" class="block w-full mt-1 rounded-md border-gray-300 shadow-sm">
                                              ...
                                              <div class="space-y-4 mt-4">
                                                  <x-label for="role" value="{{ __('Assign Role') }}" /> <select x-model="current_role_id" class="block w-full mt-1 rounded-md border-gray-300 shadow-sm">
                                                      <option value="">{{ __('Select a role') }}</option> <template x-for="(name, key) in roles" :key="key">
                                                          <option :value="key" x-text="name"></option>
                                                      </template>
                                                  </select>
                                              </div>
                                              <x-button type='button' @click='add_role()'>{{__('Add role')}}</x-button>
                                          </div>
                                      </div>
                                  </div>
