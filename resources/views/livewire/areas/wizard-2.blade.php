...
new class extends Component {
  use WithFileUploads;
    ...
    public function mount(Site $site, Area $area){
      $this->site = $site;
      $this->area = $area;
      $map = Storage::disk('public')->get('plans/site-'.$this->site->id.'/area-'.$this->area->id.'/original.svg');
      $this->url = Storage::disk('public')->url('plans/site-'.$this->site->id.'/area-'.$this->area->id.'/original.svg');
  ...
  <nav aria-label="Progress" class="p-4">
    <ol role="list" class="space-y-4 md:flex md:space-x-8 md:space-y-0"> 
      ...
      <li class="md:flex-1">
        <!-- Current Step -->
        <a class="flex flex-col border-l-4 border-gray-600 py-2 pl-4 md:border-l-0 md:border-t-4 md:pb-0 md:pl-0 md:pt-4" aria-current="step">
          <span class="text-sm font-medium text-gray-600">{{__('Step')}} 2</span>
      ...
      <div class="mt-4 flow-root">
        <div class="rounded-md bg-gray-50 p-4">
          <div class="flex">
            ...
            <div class="ml-3">
              <h3 class="text-sm font-medium text-gray-800">{{__('We have detected')}} {{$this->number_sectors}} {{__('sectors according to your file. Now, you can attach the number of your sector to the part of the plan. ')}}</h3>
