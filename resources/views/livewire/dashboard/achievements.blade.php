...
<div x-data="{ expanded: false }" class="relative">
    ...
    <div class="mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div class=" border-2 {{ $achievement->percent > 0.5 ? "border-teal-600 bg-teal-50" : ($achievement->percent > 0.1 ? "border-pink-600 bg-pink-50" : "border-purple-600 bg-purple-50" ) }}  rounded-lg p-4">
                <div class="flex items-start">
                    <div class="flex-shrink-0">
                        <svg class="h-6 w-6 {{ $achievement->percent > 0.5 ? "text-teal-600" : ($achievement->percent > 0.1 ? "text-pink-600" : "text-purple-600" ) }}" fill="currentColor" viewBox="0 0 20 20">
