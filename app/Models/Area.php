...
class Area extends Model
{
    ...
    public function svgSchema(?bool $android = false){
        // if explicit android=true -> return android.svg if exists
        if($android === true){
            if(Storage::exists('plans/site-'.$this->site->id.'/area-'.$this->id.'/edited/android.svg')){
